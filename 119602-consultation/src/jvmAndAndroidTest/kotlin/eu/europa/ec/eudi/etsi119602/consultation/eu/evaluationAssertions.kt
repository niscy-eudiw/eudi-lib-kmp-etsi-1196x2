...
val CertificateProfileValidatorJVM = CertificateProfileValidator(CertificateOperationsJvm)

fun CertificateConstraintEvaluation.Violated.assertSingleViolation(
    message: String? = null,
